...
2. Read the matching reference before writing markup:
    ...
    - Sidebar: [references/sidebar.md](references/sidebar.md)
...
- For Livewire state, confirm that the PHP property type matches the component value type.Use the package's Blade components instead of recreating shadcn/ui markup or copying React components.
