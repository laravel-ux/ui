...
<button
    ...
    type="button"
    x-cloak
    x-data="{ __switchChecked: @js($attributes->get('checked') ?? false) }"
    x-modelable="__switchChecked"
    x-on:click="__switchChecked = ! __switchChecked"
    x-bind:data-state="__switchChecked ? 'checked' : 'unchecked'"
    x-bind:aria-checked="__switchChecked"
    @disabled($disabled)
