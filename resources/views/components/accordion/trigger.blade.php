...
<div class="flex">
    <button
        ...
        x-on:click="__accordionValue = (__accordionValue !== @js($value) ? @js($value): '')"
        x-bing:aria-expanded="__accordionValue === @js($value)"
        x-bind:data-state="__accordionValue === @js($value) ? 'open' : 'closed'"
    >
        {{ $slot }}
